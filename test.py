...
DATE = ( datetime.now() - timedelta(
  days=90)).replace(microsecond=0).isoformat()
...
print('API request ended with rc=' + str(api_rc) + ', and took ' + str((api_time_end - api_time_start).total_seconds()) + ' seconds to complete.')
